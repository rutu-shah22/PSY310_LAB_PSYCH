...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/rutushah/Downloads/PyshcoPy Experiments/Adaptive staircase/adaptive_staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    level = thisTrial_2 = 10  # initialise some vals
    ...
    for thisTrial_2 in trials_2:
        ...
        trials_2.addResponse(key_resp.corr, level)
        trials_2.addOtherData('key_resp.rt', key_resp.rt)
